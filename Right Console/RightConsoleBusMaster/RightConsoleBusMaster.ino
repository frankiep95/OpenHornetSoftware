...
void onArrestingHookLtChange(unsigned int newValue) {
    sprintf((char*)data, "HKLT %d", newValue);
    muxBus.send(2, data, strlen((char*)data)); 
...
void onHydIndLeftChange(unsigned int newValue) {
    sprintf((char*)data, "HYDL %d", newValue);
    muxBus.send(2, data, strlen((char*)data));
}DcsBios::IntegerBuffer hydIndLeftBuffer(FA_18C_hornet_HYD_IND_LEFT, onHydIndLeftChange);

void onHydIndRightChange(unsigned int newValue) {
    sprintf((char*)data, "HYDR %d", newValue);
    muxBus.send(2, data, strlen((char*)data));
}DcsBios::IntegerBuffer hydIndRightBuffer(FA_18C_hornet_HYD_IND_RIGHT, onHydIndRightChange);

void onVoltEChange(unsigned int newValue) {
    sprintf((char*)data, "BATE %d", newValue);
    muxBus.send(3, data, strlen((char*)data)); 
}DcsBios::IntegerBuffer voltEBuffer(FA_18C_hornet_VOLT_E, onVoltEChange);

void onVoltUChange(unsigned int newValue) {
    sprintf((char*)data, "BATU %d", newValue);
    muxBus.send(3, data, strlen((char*)data));  
}DcsBios::IntegerBuffer voltUBuffer(FA_18C_hornet_VOLT_U, onVoltUChange);

void onPitotHeatSwChange(unsigned int newValue) {
    sprintf((char*)data, "PTOT %d", newValue);
...
void onBleedAirPullChange(unsigned int newValue) {
    sprintf((char*)data, "AUGC %d", newValue);
    muxBus.send(4, data, strlen((char*)data)); 
...
void onInstPnlDimmerChange(unsigned int newValue) {
    sprintf((char*)data, "BKLT %d", newValue);
    muxBus.send(6, data, strlen((char*)data));
}
