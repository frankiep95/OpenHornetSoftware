...
DcsBios::Potentiometer ampcdBrtCtl("AMPCD_BRT_CTL", AMPCD_ROT_A,true);
...
// Serial.println("change");
    ...
    if (address.equals("7546")) {
      ...
      analogWrite(AMPCD_BACK_LIGHT,smallValue );
