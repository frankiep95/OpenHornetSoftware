...
// Define pins for DCS-BIOS per interconnect diagram.
 ...
 #define ILS_SW1 A9  ///< ILS Channel 1
 #define ILS_SW2 A6  ///< ILS Channel 2
 #define ILS_SW3 A8  ///< ILS Channel 3
 #define ILS_SW4 A7  ///< ILS Channel 4
 ...
 #define COMANT_SW1 40  ///< ANT SEL Panel COMM 1 LOWER
 #define COMANT_SW2 41  ///< ANT SEL Panel COMM 1 UPPER
 #define IFFANT_SW1 38  ///< ANT SEL Panel IFF LOWER
 #define IFFANT_SW2 39  ///< ANT SEL Panel IFF UPPER
...
//SWITCHES
DcsBios::Switch3Pos comCommGXmtSw("COM_COMM_G_XMT_SW", GXMT_SW2, GXMT_SW1);
DcsBios::Switch3Pos comCommRelaySw("COM_COMM_RELAY_SW", RLY_SW2, RLY_SW1);
...
DcsBios::Switch3Pos comIffMode4Sw("COM_IFF_MODE4_SW", MODE4_SW2, MODE4_SW1);
DcsBios::Switch2Pos comIlsUfcManSw("COM_ILS_UFC_MAN_SW", ILSUFC_SW1,1);
